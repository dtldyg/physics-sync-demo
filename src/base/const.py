...
# SyncMode
SHOW_SERVER = True
SERVER_INPUT_BUFFER = False

MASTER_NONE = '无'
MASTER_FOLLOW = '追随插值'
MASTER_PREDICT = '预测回滚'
MASTER_BEHAVIOR_LIST = [MASTER_NONE, MASTER_FOLLOW, MASTER_PREDICT]
MASTER_BEHAVIOR = MASTER_NONE

REPLICA_NONE = '无'
REPLICA_FOLLOW = '追随插值'
REPLICA_PREDICT = '预测回滚'
REPLICA_BEHAVIOR_LIST = [REPLICA_NONE, REPLICA_FOLLOW, REPLICA_PREDICT]
REPLICA_BEHAVIOR = REPLICA_NONE

FOLLOW_LINEAR = '线性'
FOLLOW_CUBIC = '三次方'
REPLICA_FOLLOW_LIST = [FOLLOW_LINEAR, FOLLOW_CUBIC]
REPLICA_FOLLOW_MODE = FOLLOW_LINEAR

PREDICT_NONE = '无'
PREDICT_BLENDER = '物理混合'
REPLICA_PREDICT_LIST = [PREDICT_NONE, PREDICT_BLENDER]
REPLICA_PREDICT_MODE = PREDICT_NONE
