...
import logic.component_extrapolation as component_extrapolation
...
class EntityPlayerReplica(ecs.Entity):
	def __init__(self, eid, pos):
		...
		self.add_component(component_extrapolation.ComponentExtrapolation(pos))
		self.add_component(component_interpolation.ComponentInterpolation(pos))
